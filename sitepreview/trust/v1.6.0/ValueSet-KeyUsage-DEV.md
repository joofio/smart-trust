# WHO GDHCN Key Usage ValueSet - DEV - WHO SMART Trust v1.6.0
...
| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/ValueSet/KeyUsage-DEV | *Version*:1.6.0 |
| Active as of 2026-05-19 | *Computable Name*:KeyUsage-DEV |
...
##### WHO GDHCN Key Usage ValueSet - DEV Schema API
...
### GET /ValueSet-KeyUsage-DEV.schema.json

#### JSON Schema definition for the enumeration ValueSet-KeyUsage-DEV

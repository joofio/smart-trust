# WHO Regional Offices - WHO SMART Trust v1.6.0
...
## ValueSet: WHO Regional Offices (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:http://smart.who.int/trust/ValueSet/WHORegionalOffices | *Version*:1.6.0 |
| Active as of 2026-05-19 | *Computable Name*:WHORegionalOffices |
...
##### WHO Regional Offices Schema API
...
### GET /ValueSet-WHORegionalOffices.schema.json

#### JSON Schema definition for the enumeration ValueSet-WHORegionalOffices
...
```json
{
  ...
  "compose" : {
    "include" : [{
      "system" : "http://smart.who.int/trust/CodeSystem/WHORegionalOffices"
    }]
  }
}

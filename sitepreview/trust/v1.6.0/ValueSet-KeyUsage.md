# WHO GDHCN Key Usage ValueSet - WHO SMART Trust v1.6.0
...
| Active as of 2026-05-19 | *Computable Name*:KeyUsage |
...
##### WHO GDHCN Key Usage ValueSet Schema API
...
### GET /ValueSet-KeyUsage.schema.json

#### JSON Schema definition for the enumeration ValueSet-KeyUsage

This endpoint serves the JSON Schema definition for the enumeration ValueSet-KeyUsage.
